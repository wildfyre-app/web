...
import { MatCardModule, MatIconModule, MatListModule, MatMenuModule, MatSlideToggleModule, MatDialogRef,
    ...
    beforeEach(() => {
      const mdDialogStub = {
        ...
        TestBed.configureTestingModule({
            ...
            imports: [ MatCardModule, MatIconModule, MatListModule, MatMenuModule, FormsModule,
